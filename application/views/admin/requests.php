	    ...
	    <div class="sidebar" data-color="blue" data-image="../assets/img/sidebar-1.jpg">
			...
			<div class="logo">
				<a href="#" class="simple-text">
					<label><img src="../assets/img/logo.png" style="width: 25px; height: 25px"></label> Mail REacall
				</a>
			</div>
	                                    ...
	                                    <tbody>
	                                        <tr>
												...
												<td class="text-primary"> 
													<a href="#" class="btn btn-green btn-round" disabled>pending<div class="ripple-container"></div></a>
												</td>
